...
class MyForm(FlaskForm):
    pclass  = StringField('pclass', validators=[DataRequired()], render_kw={"placeholder": "Write a number..."})
    sex     = StringField('sex', validators=[DataRequired()], render_kw={"placeholder": "female/male"})
    age     = StringField('age', validators=[DataRequired()], render_kw={"placeholder": "Write a number..."})
...
def dataprediction():
    ...
    if form.validate_on_submit():
        ...
        return render_template('index.html', form=form, data=data, api_status=send_request_deployed, api_response=api_response, prediction=prediction)
